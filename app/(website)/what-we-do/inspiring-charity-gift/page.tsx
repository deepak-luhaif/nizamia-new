    ...
    <div className=''>
      ...
      <div className='container-box bg-gray-50'>
        ...
        <Tabs defaultValue='livelihood' className='w-full '>
          <TabsList className='grid w-full  lg:h-20 h-auto grid-cols-1 md:grid-cols-3 mb-8 bg-greenColor gap-5'>
            <TabsTrigger
              value='livelihood'
              className='text-lg py-3 font-roboto text-white border border-gray-200 '
            >
