...
const Donate = () => {
  ...
  return (
    <div className="relative w-full h-[400px]">
      {/* Background Image */}
      <Image
        src={"/assets/images/shoot/donate.jpg"}
      ...
      <form
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 text-center  w-full lg:px-10  "
      >
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="General Charity">General Charity</SelectItem>
        ...
        <div className="flex flex-row gap-5 justify-between mt-7 ">
          ...
          {/* <a href="">
            <Button
              className="bg-lightOrange hover:bg-orange-600 rounded-3xl font-semibold py-6 px-5"
              // type="submit"
            >
              Donate
            </Button>
          ...
          <a href="https://rzp.io/rzp/MRrhoyaM" className="justify-end mx-auto">
            <div className="bg-lightOrange hover:bg-[#d14e3a] rounded-3xl font-semibold py-3 px-5 text-white">
              Donate
            </div>
          </a>
        </div>
